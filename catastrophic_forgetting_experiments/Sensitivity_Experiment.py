...
# FIX: Patch to stop Model Card Crash in TRL
...
class ExperimentConfig:
    ...
    # Updated Batch Sizes for 1.5B Model Safety
    @property
    def batch_size(self): return 1 if self.TEST_MODE else 2 
    @property
    def grad_accum(self): return 4 if self.TEST_MODE else 8 
...
class ExperimentController:
    def __init__(self):
        print(f"Initializing Experiment Controller using: {cfg.model_id}")
    ...
    def run_training(self, run_name, train_dataset, model=None, peft_config=None, specific_beta=None):
        ...
        # Ensure PeftConfig exists if model is Dense
    ...
    # --- EVALUATION ---
    def evaluate_model(self, model, dataset, name):
        model.eval()
        correct, total = 0, 0
    ...
    def run_method_2_replay(self, ds_a, ds_b):
        """Experience Replay: Mix 25% of A into B"""
...
if __name__ == "__main__":
    ...
    # Define the list of methods to run (RESTRICTED TO BASELINE AND REPLAY)
    methods_to_run = [
